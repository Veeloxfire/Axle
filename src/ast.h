...
MOD(TUPLE_LIT_UP, TUPLE_LIT) \
MOD(TUPLE_LIT_DOWN, TUPLE_LIT) \
MOD(TUPLE_LIT_KNOWN_UP_PREFIX, TUPLE_LIT) \
MOD(TUPLE_LIT_KNOWN_UP_ELEMENTS, TUPLE_LIT) \
MOD(TUPLE_LIT_KNOWN_DOWN, TUPLE_LIT) \
...
MOD(STRUCT_EXPR, STRUCT_EXPR) \
MOD(TYPED_NAME_UP, TYPED_NAME) \
MOD(TYPED_NAME_DOWN, TYPED_NAME) \
MOD(ASSIGN_UP, ASSIGN) \
MOD(ASSIGN_DOWN, ASSIGN) \
MOD(BLOCK_UP, BLOCK) \
